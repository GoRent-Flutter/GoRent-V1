...
class RamallahScreen extends StatefulWidget {
  final int currentIndex;
  RamallahScreen({Key? key, required this.currentIndex}) : super(key: key);

  @override
  RamallahScreenState createState() => RamallahScreenState();
}

class RamallahScreenState extends State<RamallahScreen> {
        ...
        setState(() {
          allItems = estates.entries
              .where((entry) =>
                  ...
                  entry.value['city'].toString() == "رام الله")
