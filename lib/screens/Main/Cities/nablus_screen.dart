...
class NablusScreen extends StatefulWidget {
  final int currentIndex;
  NablusScreen({Key? key, required this.currentIndex}) : super(key: key);

  @override
  NablusScreenState createState() => NablusScreenState();
}

class NablusScreenState extends State<NablusScreen> {
        ...
        setState(() {
          allItems = estates.entries
              .where((entry) =>
                  ...
                  entry.value['city'].toString() == "نابلس")
